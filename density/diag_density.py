...
def compute_density(experiment: str, files:list, output_dir: str):
    ...
    oce_data = xr.open_mfdataset(files).groupby("time_counter.year").mean()
    ...
    out_file = experiment+'_density.nc'
    out_path = os.path.join(output_dir, out_file)
    ds_final = xr.concat(ds_all, dim="year")
    ds_final.to_netcdf(out_path, mode="w")
...
def main():
    ...
    try:
        ...
        density = compute_density(args.experiment, oce_files, output_dir)
